...
class StartContainerTest(BaseAPIClientTest):
    def test_start_container(self):
        ...
        assert args[0][1] == url_prefix + 'containers/{}/start'.format(fake_api.FAKE_CONTAINER_ID)
...
class ContainerTest(BaseAPIClientTest):
    ...
    def test_resize_container(self):
        ...
        fake_request.assert_called_with(
            'POST',
            url_prefix + 'containers/{}/resize'.format(fake_api.FAKE_CONTAINER_ID),
            params={'h': 15, 'w': 120},
            timeout=DEFAULT_TIMEOUT_SECONDS
        )
    ...
    def test_rename_container(self):
        ...
        fake_request.assert_called_with(
            'POST',
            url_prefix + 'containers/{}/rename'.format(fake_api.FAKE_CONTAINER_ID),
            params={'name': 'foobar'},
            timeout=DEFAULT_TIMEOUT_SECONDS
        )
    ...
    def test_wait(self):
        ...
        fake_request.assert_called_with(
            'POST',
            url_prefix + 'containers/{}/wait'.format(fake_api.FAKE_CONTAINER_ID),
            timeout=None,
            params={}
        )
    ...
    def test_logs(self):
        ...
        fake_request.assert_called_with(
            'GET',
            url_prefix + 'containers/{}/logs'.format(fake_api.FAKE_CONTAINER_ID),
    ...
    def test_diff(self):
        ...
        fake_request.assert_called_with(
            'GET',
            url_prefix + 'containers/{}/changes'.format(fake_api.FAKE_CONTAINER_ID),
            timeout=DEFAULT_TIMEOUT_SECONDS
        )
    ...
    def test_port(self):
        ...
        fake_request.assert_called_with(
            'GET',
            url_prefix + 'containers/{}/json'.format(fake_api.FAKE_CONTAINER_ID),
            timeout=DEFAULT_TIMEOUT_SECONDS
        )
    ...
    def test_stop_container(self):
        ...
        fake_request.assert_called_with(
            'POST',
            url_prefix + 'containers/{}/stop'.format(fake_api.FAKE_CONTAINER_ID),
            params={'t': timeout},
    ...
    def test_pause_container(self):
        ...
        fake_request.assert_called_with(
            'POST',
            url_prefix + 'containers/{}/pause'.format(fake_api.FAKE_CONTAINER_ID),
            timeout=(DEFAULT_TIMEOUT_SECONDS)
        )
    ...
    def test_unpause_container(self):
        ...
        fake_request.assert_called_with(
            'POST',
            url_prefix + 'containers/{}/unpause'.format(fake_api.FAKE_CONTAINER_ID),
            timeout=(DEFAULT_TIMEOUT_SECONDS)
        )
    ...
    def test_kill_container(self):
        ...
        fake_request.assert_called_with(
            'POST',
            url_prefix + 'containers/{}/kill'.format(fake_api.FAKE_CONTAINER_ID),
            params={},
            timeout=DEFAULT_TIMEOUT_SECONDS
        )
    ...
    def test_restart_container(self):
        ...
        fake_request.assert_called_with(
            'POST',
            url_prefix + 'containers/{}/restart'.format(fake_api.FAKE_CONTAINER_ID),
            params={'t': 2},
    ...
    def test_remove_container(self):
        ...
        fake_request.assert_called_with(
            'DELETE',
            url_prefix + 'containers/{}'.format(fake_api.FAKE_CONTAINER_ID),
    ...
    def test_export(self):
        ...
        fake_request.assert_called_with(
            'GET',
            url_prefix + 'containers/{}/export'.format(fake_api.FAKE_CONTAINER_ID),
            stream=True,
            timeout=DEFAULT_TIMEOUT_SECONDS
        )
    ...
    def test_container_stats(self):
        ...
        fake_request.assert_called_with(
            'GET',
            url_prefix + 'containers/{}/stats'.format(fake_api.FAKE_CONTAINER_ID),
            timeout=60,
            stream=True
        )
    ...
    def test_container_top(self):
        ...
        fake_request.assert_called_with(
            'GET',
            url_prefix + 'containers/{}/top'.format(fake_api.FAKE_CONTAINER_ID),
            params={},
            timeout=DEFAULT_TIMEOUT_SECONDS
        )
    ...
    def test_container_update(self):
        ...
        args = fake_request.call_args
        assert args[0][1] == url_prefix + 'containers/{}/update'.format(fake_api.FAKE_CONTAINER_ID)
